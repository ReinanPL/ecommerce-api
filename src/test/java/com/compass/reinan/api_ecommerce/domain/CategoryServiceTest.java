...
public class CategoryServiceTest {
    ...
    public void saveCategory_WithValidData_ShouldSaveAndReturnResponseDto() {
        ...
        when(mapper.toResponse(CATEGORY)).thenReturn(CATEGORY_RESPONSE_DTO);

        CategoryResponse actualResponseDto = categoryService.saveCategory(CATEGORY_REQUEST_DTO);
    ...
    public void findCategoryById_WithExistingId_ShouldReturnResponseDto() {
        ...
        CategoryResponse actualResponseDto = categoryService.findCategoryById(1L);
    ...
    public void activateCategory_WithInactiveCategory_ShouldReturnActivatedCategory() {
        ...
        when(mapper.toResponse(CATEGORY_ACTIVE)).thenReturn(CATEGORY_RESPONSE_DTO);

        CategoryResponse actualResponseDtoList = categoryService.activeCategory(1L);
    ...
    public void updateCategoryName_WithValidNewName_ShouldReturnUpdatedCategory() {
        ...
        when(mapper.toResponse(CATEGORY_NEW_NAME)).thenReturn(CATEGORY_RESPONSE_NEW_NAME_DTO);

        CategoryResponse actualResponseDto = categoryService.modifyCategoryName(1L, newCategoryName);
    ...
    public void getAllCategories_WithCategories_ShouldReturnListOfCategoryDtos() {
        ...
        List<CategoryResponse> actualResponseDtoList = categoryService.getAllCategories();
