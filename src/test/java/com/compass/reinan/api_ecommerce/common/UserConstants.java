...
public class UserConstants {
    ...
    public static final User USER_EXISTING = new User("52624127003", "John", "Doe", "johndoe@email.com", "123456", Role.CLIENT, ADDRESS, null, null, null);
    public static final User USER_ADMIN = new User("93619622051", "Lean", "Doe", "leandoe@email.com", "123456", Role.ADMIN, ADDRESS, null, null, null);
    public static final User USER_ADDRESS_UPDATE = new User("52624127003", "John", "Doe", "johndoe@email.com", "123456", Role.CLIENT, ADDRESS_UPDATE, null, null, null);

    public static final User NEW_USER_EMAIL = new User("52624127003", "John", "Doe", "john@email.com", "123456", Role.CLIENT, ADDRESS, null, null, null);
    public static final User NEW_USER_ROLE = new User("52624127003", "John", "Doe", "johndoe@email.com", "123456", Role.CLIENT, ADDRESS, null, null, null);


    public static final User USER_PASSWORD_ENCRYPTED = new User("52624127003", "John", "Doe", "johndoe@email.com", "$2a$12$QJPRdVvwJGjqempA7cv8qecnOSjxGIKKubGt9dle2cIGkvmQQqOcS", Role.CLIENT, ADDRESS, null, null, null);
